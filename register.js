...
export function initializeAuth() {
  ...
  userTypeSelect.className = 'mt-3 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50';
  ...
  function updateModalContent() {
    ...
    if (userTypeContainer) {
      userTypeContainer.innerHTML = '<label for="userType" class="block text-sm font-medium text-gray-700 mb-2 mt-4">User Type</label>';
